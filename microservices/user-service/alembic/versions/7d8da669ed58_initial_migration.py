...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_departments_faculty_id"), "departments", ["faculty_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_semesters_department_id"), "semesters", ["department_id"], unique=False
    )
    op.create_table(
        "courses",
        sa.Column("name", sa.String(length=255), nullable=False),
    ...
    op.create_index(
        op.f("ix_courses_semester_id"), "courses", ["semester_id"], unique=False
    )
    op.create_table(
        "user_profiles",
    ...
    op.create_index(
        op.f("ix_books_qdrant_collection_name"),
        "books",
