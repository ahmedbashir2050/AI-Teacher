...
from app.repository import book_repository, chat_repository
from app.services.llm_service import llm_service


def handle_chat_message(
    db: Session, user: User, session_id: UUID | None, user_message: str, book_id: int
) -> tuple[str, UUID]:
    ...
    relevant_chunks = retrieve_relevant_chunks(
        user_message, collection_name=book.qdrant_collection_name
    )
